    ...
    public sealed class ServiceConfiguration : IEntityTypeConfiguration<Service>
    {
        public void Configure(EntityTypeBuilder<Service> builder)
        {
            ...
            builder.HasData(
                new Service
                {
                    Id = Guid.Parse("aaaaaaaa-abaa-aaaa-aaaa-aaaaaaaaaaa1"),
                ...
                new Service
                {
                    Id = Guid.Parse("aaaaaaaa-aaaa-aaaa-aaaa-aaaacaaaaaa2"),
                ...
                new Service
                {
                    Id = Guid.Parse("aaaaaaaa-aaaa-aafa-aaaa-aaaaaaaaaaa3"),
                    Title = "Boks & Kickboks",
                ...
                new Service
                {
                    Id = Guid.Parse("aaacaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4"),
                    Title = "Online Koçluk",
                ...
                new Service
                {
                    Id = Guid.Parse("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaeaaaaa4"),
                ...
                ,new Service
                {
                    Id = Guid.Parse("aaaafaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4"),
                    Title = "Pilates",
                    Description = "Uzaktan program, beslenme önerileri ve düzenli kontrol.",
